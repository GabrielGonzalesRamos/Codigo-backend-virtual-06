...
SECRET_KEY = 'django-insecure-21v(nsd!zv_qu2$*rmy@h2wgg-=dsf-j4et5%5(3!(s@_m)h$q'
...
# Cuando se sobreescribe el modelo de autenticacion (auth_user), se debe de declarar en el settings
