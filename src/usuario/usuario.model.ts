...
const usuarioSchema = new Schema({ 
    ...
    usuarioNombre: { type: Schema.Types.String, alias: 'nombre', required: true },
    usuarioPassword: { type: Schema.Types.String, set: (valor: string) => { hashSync(valor, 10) }, alias: 'password', required: true },
