...
export const tipoRequestDto = (req: Request, res: Response, next: NextFunction): Response | void => {
...
export const accionRequestDto = ( req: Request, res: Response, next: NextFunction ): Response | void => {
    ...
    if(data?.accionDescripcion){
        ...
        const rpta: TRespuesta = {
            success: false,
            content: null,
            message: "Falta el accionDescripcion",
        };
        return res.status(400).json(rpta);
    };
}; 
...
export const loginRequestDto = ( req: Request, res: Response, next: NextFunction ): Response | void => {
    ...
    if(data?.email && data?.password){
        ...
        const rpta: TRespuesta = {
            content: null,
            message: "Falta el email y el password",
            success: false,
        }
        return res.status(400).json(rpta)
    }
...
export const productoRequestDto = ( req: Request, res: Response, next: NextFunction ): Response | void => {
...
export const movimientoRequestDto = (req: RequestCustom, res: Response, next: NextFunction) => {
    ...
    if(data.movimientoDetalle && data.movimientoFecha && data.movimientoTipo){
        ...
        const rpta: TRespuesta = {
            success: false,
            content: null,
            message:  'Falta detalles del movimiento',
        };
        return res.status(400).json(rpta);
    }
}